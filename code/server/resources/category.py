...
class Category(Resource):
    ...
    def post(self, name):
        if CategoryModel.find_by_name(name):
            return {'success': False, 'message': 'A category with this name already exists'}, 400
        ...
        return {'success': True, 'message': 'A category was successfully created'}, 201
    ...
    def delete(self, name):
        ...
        try:
            ...
            return{'success': False, 'message': 'Something went wrong.'}, 500
        return {'success': True, 'message': 'Category was successfully deleted.'}, 200
